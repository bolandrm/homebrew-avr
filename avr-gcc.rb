...
class AvrGcc < Formula
    ...
    url 'http://mirrors-usa.go-parts.com/gcc/releases/gcc-4.9.2/gcc-4.9.2.tar.bz2'
    mirror 'ftp://mirrors-usa.go-parts.com/gcc/releases/gcc-4.9.2/gcc-4.9.2.tar.bz2'
